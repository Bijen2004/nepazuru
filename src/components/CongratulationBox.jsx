...
const CongratulationBox = () => {
  return (
    ...
    items-center border-4 border-dashed border-[#3C5A68]">
      <h1 className="text-3xl font-guerrilla mt-6">CONGRATULATIONS</h1>
      <p className="text-2xl mt-8 text-[#BBCAD1]">
        You've completed this puzzle.
      </p>
      <div className="w-full mt-6 p-2">
        <div className="w-full flex justify-evenly mt-2 p-4">
          <button className="h-[50px] w-[100px] bg-[#3C5A68] font-guerrilla border border-white">
            RESTART
          </button>
          <button className="h-[50px] w-[100px] bg-[#3C5A68] font-guerrilla border border-white">
            EXIT
        ...
        <div className="w-full flex justify-evenly mt-2 p-4">
          <button className="h-[50px] w-[160px] bg-[#3C5A68] font-guerrilla border border-white">
            LEADERBOARD
          </button>
        </div>
      </div>
